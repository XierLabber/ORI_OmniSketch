...
class THD_CHCMSketch : public SketchBase<key_len, T> {
private:
  int32_t depth;
  int32_t width;
  ...
  THD_CHCMSketch(const THD_CHCMSketch &) = delete;
  THD_CHCMSketch(THD_CHCMSketch &&) = delete;
...
public:
   ...
   *
   */
  THD_CHCMSketch(int32_t depth, int32_t width, double cnt_no_ratio,
...
THD_CHCMSketch<key_len, no_layer, T, hash_t>::THD_CHCMSketch(
...
template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
void THD_CHCMSketch<key_len, no_layer, T, hash_t>::update(
...
template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
T THD_CHCMSketch<key_len, no_layer, T, hash_t>::query(
...
template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
size_t THD_CHCMSketch<key_len, no_layer, T, hash_t>::size() const {
...
template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
void THD_CHCMSketch<key_len, no_layer, T, hash_t>::clear() {
  ch->clear();
}
