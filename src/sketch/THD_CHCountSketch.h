...
class THD_CHCountSketch : public SketchBase<key_len, T> {
private:
  int32_t depth;
  int32_t width;
  hash_t *hash_fns;
  ...
  THD_CHCountSketch(const THD_CHCountSketch &) = delete;
  THD_CHCountSketch(THD_CHCountSketch &&) = delete;
...
public:
   ...
   *
   */
  THD_CHCountSketch(int32_t depth_, int32_t width_, double cnt_no_ratio,
...
int32_t THD_CHCountSketch<key_len, no_layer, T, hash_t>::getDepth() const{
  return depth;
}

template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
int32_t THD_CHCountSketch<key_len, no_layer, T, hash_t>::getWidth() const{
  return width;
}

template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
int32_t THD_CHCountSketch<key_len, no_layer, T, hash_t>::getIndex(int32_t i, int32_t j) const{
    return i * width + j;
}

template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
T THD_CHCountSketch<key_len, no_layer, T, hash_t>::getCnt(int32_t i, int32_t j){
  return ch->getCnt(getIndex(i, j));
}

template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
THD_CHCountSketch<key_len, no_layer, T, hash_t>::THD_CHCountSketch(
...
template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
void THD_CHCountSketch<key_len, no_layer, T, hash_t>::update(const FlowKey<key_len> &flowkey,
                                             T val) {
...
template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
T THD_CHCountSketch<key_len, no_layer, T, hash_t>::query(
...
template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
size_t THD_CHCountSketch<key_len, no_layer, T, hash_t>::size() const {
  ch->print_rate("");
...
template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
void THD_CHCountSketch<key_len, no_layer, T, hash_t>::clear() {
  ch->clear();
}
