...
class SketchLearn2Tuple : public SketchBase<key_len, T> {
...
private:
  ...
  /**
   * @brief The information learned by SketchLearn2Tuple, which provides
...
public:
   ...
   *
   */
  SketchLearn2Tuple(int32_t depth_, int32_t width_);
  /**
...
int32_t SketchLearn2Tuple<key_len, T, hash_t>::get_bit(char* a, int32_t pos){
      int32_t byte = pos / 8;
      int32_t bit = pos % 8;
      if ((a[byte] & (1 << (bit))) == 0)
      {
...
template <int32_t key_len, typename T, typename hash_t>
void SketchLearn2Tuple<key_len, T, hash_t>::set_bit(char* a, int32_t pos, int32_t v){
    int32_t byte = pos / 8;
    int32_t bit = pos % 8;
    if (v == 1)
    {
...
template <int32_t key_len, typename T, typename hash_t>
void SketchLearn2Tuple<key_len, T, hash_t>::Sketch2N_p_sigma(){
    double sum;
    double square_sum;
    double tmp_r;
...
template <int32_t key_len, typename T, typename hash_t>
double SketchLearn2Tuple<key_len, T, hash_t>::normalCFD(double value){
    return 0.5 * erfc(-value / sqrt(2));
}

template <int32_t key_len, typename T, typename hash_t>
void SketchLearn2Tuple<key_len, T, hash_t>::find_possible_flows
...
template <int32_t key_len, typename T, typename hash_t>
void SketchLearn2Tuple<key_len, T, hash_t>::ExtractLargeFlows
...
template <int32_t key_len, typename T, typename hash_t>
double SketchLearn2Tuple<key_len, T, hash_t>::cal_hat_p
...
template <int32_t key_len, typename T, typename hash_t>
void SketchLearn2Tuple<key_len, T, hash_t>::RemoveFlows(){
...
template <int32_t key_len, typename T, typename hash_t>
bool SketchLearn2Tuple<key_len, T, hash_t>::Terminate(double theta){
...
template <int32_t key_len, typename T, typename hash_t>
bool SketchLearn2Tuple<key_len, T, hash_t>::my_cmp(char* s1, char* s2){
...
template <int32_t key_len, typename T, typename hash_t>
SketchLearn2Tuple<key_len, T, hash_t>::SketchLearn2Tuple(int32_t depth_, int32_t width_)
...
template <int32_t key_len, typename T, typename hash_t>
SketchLearn2Tuple<key_len, T, hash_t>::~SketchLearn2Tuple(){
...
template <int32_t key_len, typename T, typename hash_t>
size_t SketchLearn2Tuple<key_len, T, hash_t>::size() const{
   return sizeof(*this)
          + r * sizeof(hash_t)
          + (l + 1) * r * c * sizeof(T);
}
...
template <int32_t key_len, typename T, typename hash_t>
void SketchLearn2Tuple<key_len, T, hash_t>::update(const FlowKey<key_len> &flowkey, T val){
...
template <int32_t key_len, typename T, typename hash_t>
void SketchLearn2Tuple<key_len, T, hash_t>::Sketch_Learning(){
...
template <int32_t key_len, typename T, typename hash_t>
void SketchLearn2Tuple<key_len, T, hash_t>::large_flow_filter(){
  return;
}

template <int32_t key_len, typename T, typename hash_t>
Data::Estimation<key_len, T> SketchLearn2Tuple<key_len, T, hash_t>::getHeavyHitter(double threshold) const {
    if(updated || large_flows.size() == 0)
    {
      const_cast<SketchLearn2Tuple<key_len, T, hash_t>*>(this)->Sketch_Learning();
      const_cast<SketchLearn2Tuple<key_len, T, hash_t>*>(this)->updated = false;
    }
...
template <int32_t key_len, typename T, typename hash_t>
T SketchLearn2Tuple<key_len, T, hash_t>::query(const FlowKey<key_len> &flowkey) const{
...
template <int32_t key_len, typename T, typename hash_t>
void SketchLearn2Tuple<key_len, T, hash_t>::clear(){
  for(int32_t i = 0; i < l + 1; i++)
  {
