...
class CHFlowRadar : public SketchBase<key_len, T> {
private:
  ...
  CHFlowRadar(const CHFlowRadar &) = delete;
  CHFlowRadar(CHFlowRadar &&) = delete;
...
public:
   ...
   */
  CHFlowRadar(int32_t flow_filter_size, int32_t flow_filter_hash,
...
CHFlowRadar<key_len, no_layer, T, hash_t>::CHFlowRadar(
...
template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
void CHFlowRadar<key_len, no_layer, T, hash_t>::update(const FlowKey<key_len> &flowkey,
                                           T val) {
...
template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
Data::Estimation<key_len, T> CHFlowRadar<key_len, no_layer, T, hash_t>::decode() {
...
template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
size_t CHFlowRadar<key_len, no_layer, T, hash_t>::size() const {
...
template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
void CHFlowRadar<key_len, no_layer, T, hash_t>::clear() {
  // reset flow counter
  num_flows = 0;
  // reset flow filter
  flow_filter->clear();
