 ...
 * @brief Implementation of CHHHUnivMon
 *
...
class CHHHUnivMon : public SketchBase<key_len, T> {
private:
  int32_t depth;
  ...
  CHHHUnivMon(const CHHHUnivMon &) = delete;
  CHHHUnivMon(CHHHUnivMon &&) = delete;
...
public:
   ...
   *
   */
  CHHHUnivMon(int32_t depth_, int32_t width_, int32_t log_n, 
...
template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
T CHHHUnivMon<key_len, no_layer, T, hash_t>::estSketch(int32_t sketch_idx, const FlowKey<key_len> &flowkey) const{
  T values[depth];
...
template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
T CHHHUnivMon<key_len, no_layer, T, hash_t>::querySketch(int32_t sketch_idx, const FlowKey<key_len> &flowkey) const{
  T values[depth];
  for (int i = 0; i < depth; ++i) {
    int32_t idx = CS_hash_fns[sketch_idx][i](flowkey) % width[sketch_idx];
    int32_t chIdx = getCHIdx(sketch_idx, i, idx);
...
template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
void CHHHUnivMon<key_len, no_layer, T, hash_t>::updateSketch(int32_t sketch_idx, const FlowKey<key_len> &flowkey, T val){
  for(int i = 0; i < depth; i++){
    int32_t idx = CS_hash_fns[sketch_idx][i](flowkey) % width[sketch_idx];
...
template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
int32_t CHHHUnivMon<key_len, no_layer, T, hash_t>::getCHIdx(int32_t sketch_id, int32_t r, int32_t c) const{
  return (width_idx[sketch_id] + c) + r * total_length;
}

template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
int32_t CHHHUnivMon<key_len, no_layer, T, hash_t>::getGlobalHash(const FlowKey<key_len> &flowkey, int32_t layer) const{
  if(layer == 0){
    return 1;
  }
...
template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
CHHHUnivMon<key_len, no_layer, T, hash_t>::CHHHUnivMon(int32_t depth_, int32_t width_,
...
template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
CHHHUnivMon<key_len, no_layer, T, hash_t>::~CHHHUnivMon() {
  if (global_hash_fns)
...
template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
Data::Estimation<key_len, T> CHHHUnivMon<key_len, no_layer, T, hash_t>::getHeavyHitter(double val_threshold) const{
...
template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
void CHHHUnivMon<key_len, no_layer, T, hash_t>::update(const FlowKey<key_len> &flowkey,
                                         T val) {
  for (int32_t i = 0; i < logn; ++i) {
...
template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
T CHHHUnivMon<key_len, no_layer, T, hash_t>::query(const FlowKey<key_len> &flowkey) const {
...
template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
size_t CHHHUnivMon<key_len, no_layer, T, hash_t>::size() const {
...
template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
void CHHHUnivMon<key_len, no_layer, T, hash_t>::clear() {
