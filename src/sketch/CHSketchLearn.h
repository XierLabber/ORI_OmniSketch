...
template <int32_t key_len, int32_t no_layer, typename T,
          typename hash_t>
class CHSketchLearn : public SketchBase<key_len, T> {
...
private:
  ...
  /**
   * @brief The information learned by CHSketchLearn, which provides
...
public:
   ...
   *
   */
  CHSketchLearn(int32_t depth_, int32_t width_, double cnt_no_ratio,
...
template <int32_t key_len, int32_t no_layer, typename T,
          typename hash_t>
int32_t CHSketchLearn<key_len, no_layer, T, hash_t>::chIdx(int32_t k, int32_t i, int32_t j) const{
    return k * c * r + i * c + j - 1;
}

template <int32_t key_len, int32_t no_layer, typename T,
          typename hash_t>
void CHSketchLearn<key_len, no_layer, T, hash_t>::chUpdateCnt(int32_t k, int32_t i, int32_t j, T val){
    ch->updateCnt(chIdx(k, i, j), val);
}

template <int32_t key_len, int32_t no_layer, typename T,
          typename hash_t>
T CHSketchLearn<key_len, no_layer, T, hash_t>::chGetCnt(int32_t k, int32_t i, int32_t j) const{
    return ch->getCnt(chIdx(k, i, j));
}

template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
int32_t CHSketchLearn<key_len, no_layer, T, hash_t>::get_bit(char* a, int32_t pos){
      int32_t byte = pos / 8;
      int32_t bit = pos % 8;
      if ((a[byte] & (1 << (bit))) == 0)
      {
...
template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
void CHSketchLearn<key_len, no_layer, T, hash_t>::set_bit(char* a, int32_t pos, int32_t v){
    int32_t byte = pos / 8;
    int32_t bit = pos % 8;
    if (v == 1)
    {
...
template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
void CHSketchLearn<key_len, no_layer, T, hash_t>::Sketch2N_p_sigma(){
    double sum;
    double square_sum;
    double tmp_r;
...
template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
double CHSketchLearn<key_len, no_layer, T, hash_t>::normalCFD(double value){
    return 0.5 * erfc(-value / sqrt(2));
}

template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
void CHSketchLearn<key_len, no_layer, T, hash_t>::find_possible_flows
...
template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
void CHSketchLearn<key_len, no_layer, T, hash_t>::ExtractLargeFlows
...
template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
double CHSketchLearn<key_len, no_layer, T, hash_t>::cal_hat_p
...
template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
void CHSketchLearn<key_len, no_layer, T, hash_t>::RemoveFlows(){
...
template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
bool CHSketchLearn<key_len, no_layer, T, hash_t>::Terminate(double theta){
...
template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
bool CHSketchLearn<key_len, no_layer, T, hash_t>::my_cmp(char* s1, char* s2){
...
template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
CHSketchLearn<key_len, no_layer, T, hash_t>::CHSketchLearn(int32_t depth_, int32_t width_, 
             double cnt_no_ratio,
...
template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
CHSketchLearn<key_len, no_layer, T, hash_t>::~CHSketchLearn(){
...
template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
size_t CHSketchLearn<key_len, no_layer, T, hash_t>::size() const{
   ch->print_rate("");
   return sizeof(*this)
          + r * sizeof(hash_t)
          + ch->size();
...
template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
void CHSketchLearn<key_len, no_layer, T, hash_t>::update(const FlowKey<key_len> &flowkey, T val){
...
template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
void CHSketchLearn<key_len, no_layer, T, hash_t>::Sketch_Learning(){
...
template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
void CHSketchLearn<key_len, no_layer, T, hash_t>::large_flow_filter(){
  return;
}

template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
Data::Estimation<key_len, T> CHSketchLearn<key_len, no_layer, T, hash_t>::getHeavyHitter(double threshold) const {
    if(updated || large_flows.size() == 0)
    {
      const_cast<CHSketchLearn<key_len, no_layer, T, hash_t>*>(this)->Sketch_Learning();
      const_cast<CHSketchLearn<key_len, no_layer, T, hash_t>*>(this)->updated = false;
    }
...
template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
T CHSketchLearn<key_len, no_layer, T, hash_t>::query(const FlowKey<key_len> &flowkey) const{
    if(updated || large_flows.size() == 0)
    {
      const_cast<CHSketchLearn<key_len, no_layer, T, hash_t>*>(this)->Sketch_Learning();
      const_cast<CHSketchLearn<key_len, no_layer, T, hash_t>*>(this)->updated = false;
...
template <int32_t key_len, int32_t no_layer, typename T, typename hash_t>
void CHSketchLearn<key_len, no_layer, T, hash_t>::clear(){
